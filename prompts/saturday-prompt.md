...
Please read the attached Word document and format Saturday's notes according to this template for publishing online.
...
- Leave `type` as is.
- Add the footnote citing commentaries and other works (begins with "Notes this week are drawn in part from...") where it says `PasteInFromSaturdayInThePrintedWC`.
